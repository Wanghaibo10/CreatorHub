...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 登录 | 扫码/创作者/Cookie | 扫码/创作者/Cookie | 扫码/创作者/Cookie | 扫码 | Cookie | Cookie | Cookie+token |
| 作品监控 | ✅ | ✅ 创作者/关键词 | ✅ | 仅本账号 | — | — | — |
| 评论监控 | ✅ | ✅ | ✅ | 仅本账号 | — | — | — |
| 弹幕监控 | ✅ | — | — | — | — | — | — |
...
**添加账号**：顶部选平台 → 左侧「账号」→ 扫码 / 创作者登录 / Cookie 粘贴。图文平台只有 Cookie 登录，保存后会自动验证一次登录态；公众号还需填后台 URL 里的 `token`。
